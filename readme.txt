...
- If customer types characters instead of numbers, program cautions the customer to retype numbers

- When correct quantity if typed, program displays amount to pay in Euros, and also displays amount left in stock after subtracting customer’s quantity bought.
